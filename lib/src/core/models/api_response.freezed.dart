...
abstract class $ApiResponseCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({bool success, T data, String? message, String? code});
}
...
class _$ApiResponseImpl<T> implements _ApiResponse<T> {
  const _$ApiResponseImpl(
      {required this.success, required this.data, this.message, this.code});
  ...
  int get hashCode => Object.hash(runtimeType, success,
      const DeepCollectionEquality().hash(data), message, code);
...
abstract class _ApiResponse<T> implements ApiResponse<T> {
  const factory _ApiResponse(
      ...
      final String? message,
      final String? code}) = _$ApiResponseImpl<T>;
